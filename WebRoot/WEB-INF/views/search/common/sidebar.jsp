...
<div class="sidebar">
	...
	<div class="gadget">
		...
		<div class="clr"></div>
		<ul class="ex_menu">
			<li><a href="http://www.dreamtemplate.com" title="Õ¾³¤ËØ²Ä">DreamTemplate</a><br />
				Over 6,000+ Premium Web Templates</li>
			<li><a href="http://www.templatesold.com"
				title="WordPress Themes">TemplateSOLD</a><br /> Premium WordPress
				&amp; Joomla Themes</li>
	...
	<div class="gadget">
		...
		<div class="clr"></div>
		<p>
			<img src="${ctx}/static/images/test_1.gif" alt="image" width="19" height="20" /> <em>We
				can let circumstances rule us, or we can take charge and rule our
				lives from within </em>.<img src="${ctx}/static/images/test_2.gif" alt="image"
				width="19" height="20" />
		</p>
		<p style="float:right;">
