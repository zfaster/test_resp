...
function ScrollPic(scrollContId, arrLeftId, arrRightId, dotListId){
    ...
    this.initialize = function(){
        ...
        this.scrollContDiv = zhangxu.self(this.scrollContId);
		...
		if(this.listDiv01.offsetWidth<this.scrollContDiv.offsetWidth){
			this.stripDiv.removeChild(this.listDiv01);
			if (this.arrLeftId) {
				this.arrLeftObj = zhangxu.self(this.arrLeftId);
				if (this.arrLeftObj) {
					zhangxu.addEvent(this.arrLeftObj, "mousedown", Function("ScrollPic.childs[" + this.ID + "].rightEnd()"));
			...
			if (this.arrRightId) {
				this.arrRightObj = zhangxu.self(this.arrRightId);
				if (this.arrRightObj) {
					zhangxu.addEvent(this.arrRightObj, "mousedown", Function("ScrollPic.childs[" + this.ID + "].leftEnd()"));
        ...
        if (this.dotListId) {
            this.dotListObj = zhangxu.self(this.dotListId);
            if (this.dotListObj) {
