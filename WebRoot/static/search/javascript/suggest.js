...
(function(NS) {
    ...
    Lang.augmentObject(NS.Suggest.prototype, {
        ...
        _initContainer: function() {
			...
			var container = document.getElementById("onlyid_for_container_rongji");
			if(!container){
				container = document.createElement("div"),
				container.id="onlyid_for_container";
        ...
        requestData: function() {
            ...
            // 末尾加了一个写死的 &act=index 2011-7-4 lindent
            this.queryParams = "q=" + encodeURIComponent(this.query) + "&code=utf-8&callback=" + CALLBACK_STR+"&act=index";
